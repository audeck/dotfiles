...
lsp.on_attach(function(client, bufnr)
	...
	-- DIAGNOSTICS
	vim.keymap.set("n", "<leader>ds", ":lua vim.diagnostic.open_float()<CR>", opts)
	vim.keymap.set("n", "<leader>dk", ":lua vim.diagnostic.goto_next()<CR>", opts)
	vim.keymap.set("n", "<leader>di", ":lua vim.diagnostic.goto_prev()<CR>", opts)
